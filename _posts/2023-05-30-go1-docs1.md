...
[![Test stability of go1 holding LiDAR]({/assets/img/post/2023-05-30-go1-suspended.png})]({/assets/img/post/2023-05-31-test-go1-holding-lidar.mp4} "go1 holding lidar")
